...
values
  (
    ...
    'career',
    'read',
    'View the private career application pipeline',
    true
  ),
  (
    'admin.career.create',
    ...
    'career',
    'create',
    'Create career pipeline records and drafts',
    true
  ),
  (
    'admin.career.update',
    ...
    'career',
    'update',
    'Update career pipeline, application, and outreach statuses',
    true
  )
...
values
  ('admin.full_access', 'admin.career.read'),
  ('admin.full_access', 'admin.career.create'),
  ('admin.full_access', 'admin.career.update'),
  ('admin.viewer', 'admin.career.read')
on conflict (role_key, capability_key) do nothing;

alter role authenticator set pgrst.db_schemas =
  'public,graphql_public,iam,studio,portfolio,career';
