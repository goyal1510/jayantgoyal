...
/** Load and configure the renderer once, even when a page has many diagrams. */
  ...
  mermaidPromise ??= import("mermaid").then(({ default: mermaid }) => {
    mermaid.initialize({
      ...
      themeVariables: {
        ...
        labelBoxBkgColor: "#f4f0e8",
        labelBoxBorderColor: "#151515",
        labelTextColor: "#151515",
        loopTextColor: "#151515",
        activationBorderColor: "#e8502a",
        activationBkgColor: "#ebe5da",
        noteBkgColor: "#fff5ad",
        noteBorderColor: "#e8502a",
...
/** Render a Mermaid fence as an accessible, responsive architecture diagram. */
