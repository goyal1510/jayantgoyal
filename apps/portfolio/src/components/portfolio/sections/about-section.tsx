        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <p className="text-sm text-muted-foreground">
              Aspiring Full Stack Developer skilled in Next.js, React.js,
              JavaScript, TypeScript and Supabase. Passionate about building
              innovative solutions and collaborating with teams to ship
