...
const PROJECTS = [
  ...
  },
  {
    ...
    imageLight: "/assets/ProjectImages/Light/ecommerce.png",
    imageDark: "/assets/ProjectImages/Dark/ecommerce.png",
...
const CERTIFICATES = [
  ...
  },
  {
    ...
    path: "/assets/certificates/Internshalla/Full_Stack_Development.pdf",
    description: "Completed Full Stack Web Development training covering HTML, CSS, JavaScript, React, Node.js, Express.js, and MongoDB",
    category: "Training",
    issuer: "Internshalla",
  },
] as const
