...
export async function POST(
  ...
  try {
    ...
    console.log("Copy check - newFilePath:", newFilePath, "existingFile:", existingFile);
    ...
    if (existingFile) {
      if (overwrite) {
        ...
        console.log("Delete existing file result:", { deleteError, existingFileId: existingFile.id, userId: user.id });
    ...
    // Note: display_name is intentionally not set - UI will fall back to file_name
    // This keeps display_name, file_name, and file_path in sync (same as upload flow)
