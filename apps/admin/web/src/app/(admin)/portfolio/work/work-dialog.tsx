...
import { WorkCaseStudyFields } from "./work-case-study-fields";
import type { WorkFormData } from "./work-form-data";

export { emptyWorkForm, type WorkFormData } from "./work-form-data";

/** Coordinates the controlled work-item form and submission actions. */
