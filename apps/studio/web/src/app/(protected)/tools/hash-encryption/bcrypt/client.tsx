      ...
      <div className="grid gap-6 md:grid-cols-2">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setRounds(
                    Math.max(4, Math.min(31, parseInt(e.target.value) || 10)),
                  )
                }
              />
            ...
            >
              <RefreshCw
                className={`h-4 w-4 mr-2 ${isHashing ? "animate-spin" : ""}`}
              />
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            {isMatch !== null && (
              <div
                className={`p-3 rounded-md ${isMatch ? "bg-green-500/10 text-green-600" : "bg-red-500/10 text-red-600"}`}
              >
