...
function generateIPv6ULA(): string {
  ...
  const globalId = Array.from(array)
    ...
    <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                ...
                generated according to RFC4193
              </CardDescription>
            </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>
            IPv6 Unique Local Addresses (ULA) are defined in RFC4193 and are
            used for local, non-routable IP addresses within a private network.
          </p>
          <p>
            Prefix: fd00::/8 (with L bit set)
            <br />
            Global ID: 40-bit randomly generated identifier
            <br />
