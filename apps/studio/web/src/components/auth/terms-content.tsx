...
const PORTFOLIO_HOST = new URL(PERSON_BRAND.canonicalUrl).hostname;
    ...
    <div className="space-y-8">
      ...
      <section className="space-y-4">
        ...
        <div className="pl-9 space-y-3">
          <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            . This web service provides practical tools, experiments, and
            account-backed workspaces. By accessing or using this service, you
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            as an individual developer showcasing web development skills,
            experimental features, and technical capabilities.
          </p>
        </div>
      </section>
      ...
      <section className="space-y-4">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-xl font-semibold">
            2. Educational & Experimental Nature
          </h2>
        </div>
          ...
          <div className="rounded-lg bg-blue-500/10 border border-blue-500/20 p-4">
            ...
            <ul className="text-sm text-muted-foreground list-disc list-inside space-y-1 ml-2">
              <li>
                This is primarily a{" "}
                <strong className="text-foreground">
                  learning and demonstration service
                </strong>
              </li>
              <li>
                Features may be experimental, incomplete, or subject to sudden
                changes
              </li>
              <li>
                Technical implementations are for showcase and educational
                purposes
              </li>
              <li>
                Some features may intentionally demonstrate edge cases or
                specific technical solutions
              </li>
              <li>
                The service may include beta features that are still in
                development
              </li>
            </ul>
          </div>
          <p className="text-sm text-muted-foreground leading-relaxed">
            As this is a portfolio project, you may encounter features that are
            works in progress, experimental implementations, or demonstrations
            of specific technologies. The service may not always represent
        ...
        <div className="pl-9 space-y-4">
          <div className="rounded-lg bg-amber-500/10 border border-amber-500/20 p-4 space-y-3">
            ...
            <p className="text-sm text-amber-600 dark:text-amber-400 leading-relaxed font-medium">
              <strong>
                DO NOT STORE SENSITIVE, CONFIDENTIAL, OR CRITICAL DATA
              </strong>{" "}
              on this service.
            </p>
            <ul className="text-sm text-muted-foreground list-disc list-inside space-y-2 ml-2">
              ...
              <li>
                ...
                Credit card numbers, bank details, cryptocurrency keys
              </li>
              <li>
                <strong className="text-foreground">Credentials:</strong>{" "}
                Passwords, API keys, security tokens, private keys
              </li>
              <li>
                <strong className="text-foreground">Health Data:</strong>{" "}
              ...
              <li>
                ...
                Unpatented inventions, trade secrets
              </li>
              <li>
                <strong className="text-foreground">Legal Documents:</strong>{" "}
                Contracts, legal agreements, sensitive correspondence
              </li>
              <li>
                <strong className="text-foreground">Irreplaceable Data:</strong>{" "}
                Unique work, personal memories, one-of-a-kind files
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pl-9 space-y-4">
          <div className="rounded-lg bg-red-500/10 border border-red-500/20 p-4 space-y-3">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              <strong className="text-foreground">
                {APP_BRANDS.studio.publicName} and its owner
              </strong>{" "}
              will not be liable for:
            </p>
            <ul className="text-sm text-muted-foreground list-disc list-inside space-y-2 ml-2">
              <li>
                <strong className="text-foreground">Data Loss:</strong> Any
                loss, corruption, or unauthorized access to your data
              </li>
              <li>
                <strong className="text-foreground">Service Issues:</strong>{" "}
                Downtime, interruptions, or degraded performance
              </li>
              <li>
                <strong className="text-foreground">Technical Problems:</strong>{" "}
                Bugs, errors, crashes, or unexpected behavior
              </li>
              <li>
                <strong className="text-foreground">Security Breaches:</strong>{" "}
                Hacks, data leaks, or unauthorized access
              </li>
              <li>
                <strong className="text-foreground">Financial Loss:</strong> Any
                direct, indirect, or consequential damages
              </li>
              <li>
                <strong className="text-foreground">Third-Party Issues:</strong>{" "}
                Problems with external services or integrations
              </li>
            </ul>
            <p className="text-sm text-muted-foreground leading-relaxed pt-2">
              No warranties of any kind are provided, including but not limited
        ...
        <div className="pl-9 space-y-4">
          ...
          <div className="rounded-lg bg-amber-500/10 border border-amber-500/20 p-4">
            ...
            <ul className="text-sm text-muted-foreground list-disc list-inside space-y-1 ml-2 mt-2">
              ...
              <li>Attempt to exploit or damage the service</li>
      ...
      <section className="space-y-4">
        ...
        <div className="pl-9 space-y-3">
          ...
          <ul className="text-sm text-muted-foreground list-disc list-inside space-y-2 ml-4">
            ...
            <li>
              Engage in hacking, scraping, or unauthorized access attempts
            </li>
            <li>Overload or attempt to crash the service (DoS attacks)</li>
      ...
      <section className="space-y-4">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-xl font-semibold">
            8. Technical Requirements & Limitations
          </h2>
        </div>
        <div className="pl-9 space-y-3">
          <div className="rounded-lg bg-muted/50 border border-border p-4">
            ...
            <ul className="text-sm text-muted-foreground space-y-2">
              <li>
                • <strong className="text-foreground">Storage Limits:</strong>{" "}
                Accounts may have storage limitations
              </li>
              <li>
                • <strong className="text-foreground">Rate Limits:</strong> API
                and request limits may apply
              </li>
              <li>
                • <strong className="text-foreground">Browser Support:</strong>{" "}
                Modern browsers required (Chrome, Firefox, Safari, Edge latest
                versions)
              </li>
              <li>
                •{" "}
                <strong className="text-foreground">Mobile Experience:</strong>{" "}
                May vary by device and browser
              </li>
              <li>
                •{" "}
                <strong className="text-foreground">
      ...
      <section className="space-y-4">
        ...
        <div className="pl-9 space-y-3">
          <p className="text-sm text-muted-foreground leading-relaxed">
            All service code, design, content, and branding are the property of{" "}
            {PERSON_BRAND.displayName}
            unless otherwise stated. You may not copy, modify, distribute, or
            create derivative works without explicit permission.
          </p>
          <p className="text-sm text-muted-foreground leading-relaxed">
            Content you upload remains your property, but you grant us a license
            to store, process, and display it as necessary to provide the
            service.
          </p>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="pl-9 space-y-3">
          <p className="text-sm text-muted-foreground leading-relaxed">
            For questions about these Terms, technical issues, or general
            inquiries:
          </p>
          <div className="rounded-lg bg-primary/5 border border-primary/20 p-4">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Portfolio:{" "}
              <a
                href={`${PERSON_BRAND.canonicalUrl}/#contact`}
                target="_blank"
                rel="noreferrer"
                className="text-primary underline underline-offset-4 hover:text-primary/80 font-medium"
              >
            ...
            <p className="text-xs text-muted-foreground mt-3">
              <strong className="text-foreground">Note:</strong> As this is a
              personal portfolio project, response times may vary. For urgent
              matters, please be patient as this is not a commercial service.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="space-y-2">
          ...
          <div className="">
            <ul className="text-sm text-muted-foreground list-disc list-inside space-y-1 text-left inline-block">
              ...
              <li>
                You will not store sensitive or critical data on this service
              </li>
              <li>
                You accept the risks associated with using an
                educational/experimental service
              </li>
              <li>
                You understand the limitations of liability outlined above
              </li>
            </ul>
          </div>
        </div>
