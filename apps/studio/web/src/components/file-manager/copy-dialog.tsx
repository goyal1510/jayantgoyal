...
} from "@/components/file-manager/file-conflict-dialog";
...
export function CopyDialog({
  ...
  const [conflictResolver, setConflictResolver] = React.useState<
    ((resolution: FileConflictResolution | null) => void) | null
  >(null);
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Folder copying is not currently supported. Please copy files
              individually.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Select a destination folder for the copy of &quot;
