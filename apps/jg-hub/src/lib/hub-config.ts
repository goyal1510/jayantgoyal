...
// Tech Tools navigation items (categories)
const TECH_TOOLS_NAV: NavItem[] = [
  { id: "calculators", label: "Calculators", icon: Calculator, color: "text-blue-500 dark:text-blue-400", url: "/calculators" },
  { id: "code-dev-tools", label: "Code Dev Tools", icon: FileCode, color: "text-green-500 dark:text-green-400", url: "/code-dev-tools" },
  { id: "converters", label: "Converters", icon: ArrowRightLeft, color: "text-purple-500 dark:text-purple-400", url: "/converters" },
  { id: "formatters", label: "Formatters", icon: AlignLeft, color: "text-orange-500 dark:text-orange-400", url: "/formatters" },
  { id: "generators", label: "Generators", icon: Wand2, color: "text-pink-500 dark:text-pink-400", url: "/generators" },
  { id: "hash-encryption", label: "Hash & Encryption", icon: Lock, color: "text-red-500 dark:text-red-400", url: "/hash-encryption" },
  { id: "media-qr", label: "Media & QR", icon: Image, color: "text-cyan-500 dark:text-cyan-400", url: "/media-qr" },
  { id: "network-tools", label: "Network Tools", icon: Globe, color: "text-indigo-500 dark:text-indigo-400", url: "/network-tools" },
  { id: "parsers-validators", label: "Parsers & Validators", icon: CheckSquare, color: "text-emerald-500 dark:text-emerald-400", url: "/parsers-validators" },
  { id: "text-tools", label: "Text Tools", icon: Type, color: "text-amber-500 dark:text-amber-400", url: "/text-tools" },
  { id: "other", label: "Other", icon: MoreHorizontal, color: "text-gray-500 dark:text-gray-400", url: "/other" },
]
...
const FILE_MANAGER_NAV: NavItem[] = [
  ...
  { id: "changelog", label: "Release Notes", icon: FileText, color: "text-gray-500 dark:text-gray-400", url: "/changelog" },
]

// Activity Tracker navigation items
const ACTIVITY_TRACKER_NAV: NavItem[] = [
  { id: "dashboard", label: "Dashboard", icon: LayoutDashboard, color: "text-blue-500 dark:text-blue-400", url: "/dashboard" },
  { id: "tracker", label: "Tracker", icon: Target, color: "text-green-500 dark:text-green-400", url: "/tracker" },
  { id: "management", label: "Management", icon: Settings, color: "text-gray-500 dark:text-gray-400", url: "/management" },
]

// Currency Calculator navigation items
const CURRENCY_CALC_NAV: NavItem[] = [
  { id: "new", label: "New", icon: Plus, color: "text-green-500 dark:text-green-400", url: "/new" },
  { id: "history", label: "History", icon: History, color: "text-blue-500 dark:text-blue-400", url: "/history" },
]

// Sync Messenger navigation items
const SYNC_MESSENGER_NAV: NavItem[] = [
  { id: "messenger", label: "Messenger", icon: MessageSquare, color: "text-blue-500 dark:text-blue-400", url: "/" },
]

// All apps configuration
export const HUB_APPS: AppConfig[] = [
  // Private apps (require auth)
  {
    id: "portfolio",
    name: "Portfolio",
    icon: User,
  ...
  // Public apps (no auth required)
  {
    ...
    isPublic: true,
    navItems: [], // Single page, no sub-navigation
  },
  {
