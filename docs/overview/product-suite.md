...
Proposed products may be documented before implementation when every page is
explicit about that status and does not claim that clients, routes, schemas,
hosts, or deployments exist.
