...
| Product     | A user-facing responsibility such as Portfolio, Studio, Admin, Auth, or Shaamil |
...
Shaamil is a defined product: its name, ownership, existing-Supabase-project
decision, and extension rules are accepted. Its initial wedge and technology
remain recommendations, while its clients and runtime remain future until an
implementation milestone is explicitly approved.
