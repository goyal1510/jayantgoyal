...
const response = await request("/rest/v1/rpc/process_pending_automation_events", {
  method: "POST",
  headers: {
...
const count = await expectStatus(response, [200], "orbit.process_pending_automation_events");
console.log(`Processed ${count ?? 0} automation event(s).`);
