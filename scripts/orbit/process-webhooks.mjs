...
const response = await request("/rest/v1/rpc/process_pending_webhook_deliveries", {
  method: "POST",
  headers: {
...
const count = await expectStatus(response, [200], "orbit.process_pending_webhook_deliveries");
console.log(`Processed ${count ?? 0} webhook delivery(ies).`);
